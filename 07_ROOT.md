# 07_ROOT — Repo Kök Dosyaları
# backend-governance Project Knowledge Paketi
# CLAUDE.md + PROJECT_CONTEXT.md + diğer kök dosyalar

═══════════════════════════════════════════════════════════════
=== FILE: CLAUDE.md ===
Boyut: 6.9 KB | Son değişiklik: 2026-03-21 | Team Lead ana sözleşmesi — otomatik yüklü, her oturum
═══════════════════════════════════════════════════════════════
...
Boyut: 31.8 KB | Son değişiklik: untracked | UNTRACKED — sistemin tüm mimarisini anlatan belge
═══════════════════════════════════════════════════════════════
